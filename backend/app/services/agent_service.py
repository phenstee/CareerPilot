...
class AgentService:
    ...
    def _get_role_analysis(self, user_id: str, job_posting_id: str, role_analysis_id: str | None) -> RoleAnalysisOutput:
        if role_analysis_id:
        ...
        return RoleAnalysisOutput.model_validate(analysis.result)
